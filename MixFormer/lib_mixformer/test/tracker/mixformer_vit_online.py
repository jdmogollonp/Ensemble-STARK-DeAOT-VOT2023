from lib_mixformer.test.tracker.basetracker import BaseTracker
import torch
from lib_mixformer.train.data.processing_utils import sample_target
# for debug
import cv2
import os
from lib_mixformer.models.mixformer_vit import build_mixformer_vit_online_score
from lib_mixformer.test.tracker.tracker_utils import Preprocessor_wo_mask
from lib_mixformer.utils.box_ops import clip_box
